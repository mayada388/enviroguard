      ...
      body: SafeArea(
        child: StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
          ...
          builder: (context, userSnap) {
            ...
            final String? locationId = fromDbLocId.isNotEmpty ? fromDbLocId : null;
            ...
            final Stream<DocumentSnapshot<Map<String, dynamic>>>? aqStream =
                (locationId == null)
                    ? null
                    : FirebaseFirestore.instance.collection('air_quality_data').doc(locationId).snapshots();
                ...
                children: [
                              ...
                              children: [
                                  ...
                                  child: StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
                                    ...
                                    builder: (context, snap) {
                                      ...
                                      final ImageProvider avatarProvider =
                                          photoUrl.isNotEmpty ? NetworkImage(photoUrl) : const AssetImage('assets/avatar.png');
                                      return CircleAvatar(radius: 25, backgroundImage: avatarProvider);
                                    },
                                  ),
                                ),
                                ...
                                Expanded(
                                  child: Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text('Good evening!', style: TextStyle(color: Colors.grey[500], fontSize: 12)),
                                      const SizedBox(height: 2),
                                      Text(
                                        ((userData?['name'] ?? 'User').toString().trim().isEmpty)
                                            ? 'User'
                                            : (userData?['name'] ?? 'User').toString().trim(),
                                          ...
                                          children: [
                                            ...
                                            StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
                                              ...
                                              builder: (context, locSnap) {
                                                if (!locSnap.hasData) {
                                                  return Text('...', style: TextStyle(color: Colors.grey[700], fontSize: 14, fontWeight: FontWeight.w600));
                                                }
                                                final docs = locSnap.data!.docs;
                                                if (docs.isEmpty) {
                                                  return Text('No locations', style: TextStyle(color: Colors.grey[700], fontSize: 14, fontWeight: FontWeight.w600));
                                                }

                                                final String? safeValue =
                                                    (_selectedLocationId != null && docs.any((d) => d.id == _selectedLocationId))
                                                        ? _selectedLocationId
                                                        : null;
                                                  ...
                                                  child: DropdownButton<String>(
                                                    ...
                                                    onChanged: (newId) async {
                                                      ...
                                                      await FirebaseFirestore.instance.collection('users').doc(user.uid).set(
                                                        {'locationId': newId, 'updatedAt': FieldValue.serverTimestamp()},
                          ...
                          _HeaderIcon(
                            ...
                            onPressed: () async {
                              ...
                              await Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (_) => enabled ? const NotificationsPage() : const AlertsPage(),
                                ),
                              );
                  ...
                  StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
                    ...
                    builder: (context, metSnap) {
                      ...
                      return GridView.count(
                        ...
                        children: [
                          _MetCard(icon: Icons.compress, title: 'Pressure', value: pressure),
                          _MetCard(icon: Icons.thermostat, title: 'Temperature', value: temp),
                          _MetCard(icon: Icons.air, title: 'Wind speed', value: wind),
                          _MetCard(icon: Icons.water_drop_outlined, title: 'Humidity', value: humidity),
                        ],
                      );
                    },
                  ),
                  ...
                  StreamBuilder<DocumentSnapshot<Map<String, dynamic>>>(
                    ...
                    builder: (context, polSnap) {
                      final pol = polSnap.data?.data()?['pollutants'] as Map<String, dynamic>?;
...
const SizedBox(height: 30),
  ...
  onTap: () async {
    ...
    final locationName = (locDoc.data()?['name'] ?? locationId).toString();
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        Text(
          title,
          style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF32345F)),
        ),
      ],
    );
  }
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        children: [
          Expanded(
            child: Text(label, style: const TextStyle(fontSize: 13, color: Color(0xFF4B4B4B))),
          ),
          SizedBox(
            width: 45,
            child: Text(
